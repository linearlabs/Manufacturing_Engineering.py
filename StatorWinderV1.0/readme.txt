...
compile script with 'pyinstaller StatorWinderV1.0.py --onefile --noconsole --icon=icon.ico'
If you want a console us this instead: 'pyinstaller StatorWinderV1.0Console.py --onefile --icon=icon.ico'

'StatorWinderVx.x.py' and icon.ico are variable depending on what you want to choose
