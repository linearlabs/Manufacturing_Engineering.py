...
compile script with 'pyinstaller BackEMFTesterV1.3.py --onefile --noconsole --icon=icon.ico'
If you want a console us this instead: 'pyinstaller BackEMFTesterV1.3Console.py --onefile --icon=icon.ico'

'BackEMFTesterVx.x.py' and icon.ico are variable depending on what you want to choose

then copy and paste images, icons, and local config files into dist folder with the .exe file, modules can be excluded. (Try putting _pycache_ folder into dist as well, this might help program load faster)
