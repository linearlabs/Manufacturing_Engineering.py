...
compile script with 'pyinstaller ProdSummaryV3.py --onefile --noconsole --icon=icon.ico'

'ProdSummaryVx.py' and icon.ico are variable depending on what you want to choose
