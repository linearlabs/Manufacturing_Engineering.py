...
configFilePath = '//CTGTECH-LLDC01.linearlabs.local/Production/Production Data/Rotor Config Files/folderConfig.txt'
...
def getPartParams(modelName, part):
    try:
        ...
        configParser = configparser.RawConfigParser()   
        configFilePath = '//CTGTECH-LLDC01.linearlabs.local/Production/Production Data/Rotor Config Files/'+configFile+'.txt'
