...
compile script with 'pyinstaller rotorTestV1.4.py --onefile --icon=icon.ico'

'rotorTestVx.x.py' and icon.ico are variable depending on what you want to choose

then copy and paste images, icons, and config files into dist folder with the .exe file
...
add files > add any icons, config files or pictures that are associated with .exe > click next
