...
compile script with 'pyinstaller BackEMFTesterV1.2.py --onefile --noconsole --icon=icon.ico'
for console us this instead: 'pyinstaller BackEMFTesterV1.2.py --onefile --icon=icon.ico'

'BackEMFTesterVx.x.py' and icon.ico are variable depending on what you want to choose

then copy and paste images, icons, and local config files into dist folder with the .exe file, modules can be excluded.
