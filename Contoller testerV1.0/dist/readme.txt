...
compile script with 'pyinstaller Controller Tester V1.0.py --onefile --noconsole --icon=icon.ico'

'StatorTesterVx.x.py' and icon.ico are variable depending on what you want to choose
